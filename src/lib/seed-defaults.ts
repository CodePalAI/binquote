...
export const defaultRules: PricingRules = {
  operator_slug: "ironside-hauling",
  business_name: "Ironside Hauling Co.",
  phone: "(919) 555-0140",
  email: "book@ironside-hauling.example",
  brand_color: "#FF5A1F",
  currency: "USD",
  overage_per_ton: 75,
  estimate_disclaimer:
  ...
  zones: [
    {
      id: "core",
      label: "Raleigh metro (free delivery)",
      zips: ["27513", "27511", "27607", "27608", "27609", "27612"],
      delivery_fee: 0,
    },
    {
      id: "ring",
      label: "Inside the beltline",
    ...
    },
    {
      ...
      zips: ["27502", "27519", "27523", "27560", "27587"],
      delivery_fee: 75,
    },
  ],
};
